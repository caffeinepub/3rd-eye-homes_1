...
import type { DebitEntry as _DebitEntry, Expense as _Expense, ExternalBlob as _ExternalBlob, FlatOwner as _FlatOwner, Notice as _Notice, Payment as _Payment, SocietyProfile as _SocietyProfile, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addDebitEntry(arg0: DebitEntry): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addDebitEntry(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addFlatOwner(arg0: FlatOwner): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addFlatOwner(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addNotice(arg0: Notice): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addNotice(await to_candid_Notice_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addNoticeManual(arg0: string, arg1: string, arg2: string, arg3: ExternalBlob | null, arg4: string | null, arg5: string, arg6: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addNoticeManual(arg0, arg1, arg2, await to_candid_opt_n11(this._uploadFile, this._downloadFile, arg3), to_candid_opt_n12(this._uploadFile, this._downloadFile, arg4), arg5, arg6);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDebitEntry(arg0: bigint): Promise<DebitEntry | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getDebitEntry(arg0);
    ...
    async getFlatOwner(arg0: bigint): Promise<FlatOwner | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getFlatOwner(arg0);
    ...
    async getFlatStatement(arg0: bigint): Promise<{
        credits: Array<Payment>;
        debits: Array<DebitEntry>;
        openingBalance: bigint;
    }> {
    ...
    async getNoticesByCategory(arg0: string): Promise<Array<Notice>> {
        if (this.processError) {
            try {
                const result = await this.actor.getNoticesByCategory(arg0);
                return from_candid_vec_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPendingAmount(arg0: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getPendingAmount(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPendingFlats(): Promise<Array<{
        id: bigint;
        ownerName: string;
        password: string;
        flatStatus: string;
        ...
        if (this.processError) {
            try {
                const result = await this.actor.getPendingFlats();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getSocietyProfile(): Promise<SocietyProfile | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getSocietyProfile();
    ...
    async updateFlatOwner(arg0: FlatOwner): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateFlatOwner(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateSocietyProfile(arg0: SocietyProfile): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_Notice_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Notice): Promise<Notice> {
...
function from_candid_opt_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_DebitEntry]): DebitEntry | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Expense]): Expense | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_FlatOwner]): FlatOwner | null {
    return value.length === 0 ? null : value[0];
}
async function from_candid_opt_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Notice]): Promise<Notice | null> {
    return value.length === 0 ? null : await from_candid_Notice_n16(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Payment]): Payment | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_SocietyProfile]): SocietyProfile | null {
    return value.length === 0 ? null : value[0];
}
...
async function from_candid_record_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        attachmentName: record_opt_to_undefined(from_candid_opt_n18(_uploadFile, _downloadFile, value.attachmentName)),
...
function from_candid_record_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        flatId: record_opt_to_undefined(from_candid_opt_n7(_uploadFile, _downloadFile, value.flatId)),
        name: value.name,
        mobile: value.mobile
    };
}
...
async function from_candid_vec_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Notice>): Promise<Array<Notice>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Notice_n16(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_Notice_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Notice): Promise<_Notice> {
...
function to_candid_record_n33(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        flatId: value.flatId ? candid_some(value.flatId) : candid_none(),
        name: value.name,
        mobile: value.mobile
    };
}
