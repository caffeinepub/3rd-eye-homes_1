...
export const idlService = IDL.Service({
  ...
  'generateMonthlyDebit' : IDL.Func([IDL.Text, IDL.Text], [IDL.Record({'added': IDL.Nat, 'skipped': IDL.Nat})], []),
  'getAllDebitEntries' : IDL.Func([], [IDL.Vec(DebitEntry)], ['query']),
  'getAllExpenses' : IDL.Func([], [IDL.Vec(Expense)], ['query']),
  'getAllFlatOwners' : IDL.Func([], [IDL.Vec(FlatOwner)], ['query']),
